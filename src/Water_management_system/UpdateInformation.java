    ...
    UpdateInformation(String meter) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                tfaddress.setText(rs.getString("tfaddress"));
                tfcity.setText(rs.getString("tfcity"));
                tfstate.setText(rs.getString("tfstate"));
                tfemail.setText(rs.getString("tfemail"));
                tfphone.setText(rs.getString("tfphone"));
