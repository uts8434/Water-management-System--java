...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0XFF6464), 2), "Create-Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0XFF6464)));
        ...
        if (ae.getSource() == create) {
            ...
            try {
                ...
                if (atype.equals("Admin")) {
                    query = "insert into login values('"+smeter+"', '"+susername+"', '"+sname+"', '"+spassword+"', '"+atype+"', '"+atype+"')";
                } 
                else {
