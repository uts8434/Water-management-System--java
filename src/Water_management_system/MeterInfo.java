...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    JButton next, cancel;
    JLabel lblmeter;
    Choice meterlocation, metertype, billtype;
    String meternumber;
    MeterInfo(String meternumber) {
        ...
        meterlocation.add("Domestic");
        meterlocation.add("Commercial");
        ...
        metertype.add("Woltmann meter");
        metertype.add("Volumetric meter");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String query = "insert into meter_info values('"+meter+"', '"+location+"', '"+type+"', '"+typebill+"', '"+days+"')";
